...
STEPS: list[Analyzer] = [
    ...
    Analyzer("[*] inetd / xinetd services  (dangerous service detection)",           analyze_inetd),
    Analyzer("[*] Kernel hardening parameters  (sysctl)",                            analyze_sysctl),
    ...
    Analyzer("[*] SSH server configuration  (sshd_config dangerous settings)",        analyze_sshd_config),
    ...
    Analyzer("[*] Sensitive file permissions  (shadow / SSH keys / credential files)", analyze_sensitive_permissions),
    ...
    Analyzer("[*] HTTP server binaries",                                                analyze_httpd_binaries),
